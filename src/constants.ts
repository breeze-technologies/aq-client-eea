export const EEA_BASE_URL_UTD = "http://discomap.eea.europa.eu/map/fme/latest/";
export const EEA_TIMEZONE_DEFINITION_BASE_URL = "http://dd.eionet.europa.eu/vocabulary/aq/timezone/UTC";
